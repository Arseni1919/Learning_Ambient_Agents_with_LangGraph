...
For a brief introduction to LangGraph and some of the concepts used in this repo, see the [LangGraph 101 notebook](notebooks/1_langgraph_101.ipynb). This notebook explains the basics of chat models, tool calling, agents vs workflows, LangGraph nodes / edges / memory, and LangGraph Studio.

### Building an agent 
* Notebook: [notebooks/agent.ipynb](/notebooks/2_agent.ipynb)
...
### Evaluation 
* Notebook: [notebooks/evaluation.ipynb](/notebooks/3_evaluation.ipynb)
...
### Human-in-the-loop 
* Notebook: [notebooks/hitl.ipynb](/notebooks/4_hitl.ipynb)
...
### Memory  
* Notebook: [notebooks/memory.ipynb](/notebooks/5_memory.ipynb)
